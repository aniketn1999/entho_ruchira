...
const ContactUs = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Reset form (Optional: show a success message instead of alert)
        setFormData({ name: '', email: '', subject: '', message: '' });

        // Use a console log for success message, avoiding alert()
    ...
    const contactInfo = [
        ...
        { icon: MapPin, title: 'Our Office', detail: '789 Commerce St, Suite 100, Metropolis, USA', href: '#' },

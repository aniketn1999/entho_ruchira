...
const ContactUs = () => {
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Call Us",
      detail: "+91 90327 17675",
      href: "tel:+91 90327 17675",
    },
    {
      icon: Mail,
      title: "Email Us",
      detail: "info@enthoruchira.com",
    ...
    },
    {
      ...
      detail: "Mon - Fri: 9:00 AM - 5:00 PM EST",
      href: "#",
    },
  ];
  ...
  return (
    <div className="min-h-screen pt-28 sm:pt-32 lg:pt-20 pb-12 px-4 sm:px-6 lg:px-8 bg-[#282561]">
      <div className="max-w-6xl mx-auto">
        {/* Header Section */}
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[#ffffff]">
            Get In Touch
          </h1>
          <p className="mt-6 text-xl text-[#fdc58a] max-w-2xl mx-auto">
            We're here to answer your questions and help you with anything you
            need. Send us a message!
          </p>
        </div>
